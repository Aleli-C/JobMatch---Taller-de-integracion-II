...
import type { PublicationView, TopicView } from "./ProfileHistory";
 ...
 */
export default function OwnProfile({ historyData }: OwnProfileProps) {
  return (
        ...
        <div className="max-w-7xl mx-auto py-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <UsuarioProfileTabs historyData={historyData} />
                </div>
            </div>
        </div>
    </div>
