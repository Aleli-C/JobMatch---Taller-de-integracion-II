...
const registerSchema = z
  .object({
    Rut: z.string().min(3, "RUT requerido").refine(isValidRut, "RUT inválido"),
...
export default function Register() {
  ...
  const handleInputChange = (
    ...
    const processed =
      name === "Rut" ? formatRut(value) : value;
          ...
          <div className="flex min-h-[700px]">
            ...
            <div className="flex-1 flex items-center justify-center p-6" style={{ backgroundColor: "rgba(1,105,193,1)" }}>
              <div className="max-w-md w-full flex items-center justify-center">
                <Image src="/Register.png" alt="Registro JobMatch" className="w-full h-auto max-w-sm object-contain" width={512} height={512} />
              </div>
            </div>
          </div>
        </div>
