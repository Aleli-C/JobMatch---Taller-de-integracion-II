    ...
    <main className="min-h-screen bg-slate-50 pb-16">
      <section className="relative overflow-hidden bg-slate-900 py-16">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-4 sm:px-6 lg:px-8 text-white">
          <div className="flex flex-col gap-6 text-center lg:flex-row lg:items-end lg:justify-between lg:text-left">
            ...
            <Link
              href="/forums"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-sky-300 px-6 py-2 text-sm font-semibold text-sky-100 transition-colors hover:border-sky-200 hover:text-white"
            >
              Ver todos los foros
      ...
      <section className="mx-auto mt-12 w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Aquí puedes incrustar tu listado real de hilos cuando conectes el backend o reutilices el componente existente en tu proyecto.
        </p>
        <div className="mt-8">
          <Forum />
        </div>
