...
const JobMatch: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 shadow-blue-200">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <select name="category" onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div className="space-y-2">
                ...
                <select name="location" onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div className="space-y-2">
                ...
                <select name="jobType" onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div className="space-y-2">
                ...
                <select name="salary" onChange={handleFilterChange} className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div className="mt-4">
              <input type="text" placeholder="Filtrar por palabra clave..." onChange={handleSearchChange} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>
          </div>
        </section>

        {/* SECTION: Grid de ofertas de trabajo */}
        <section className="mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {currentJobs.map((job: Job) => (
              <div key={job.id} className="bg-white rounded-lg shadow-sm shadow-blue-100 border border-gray-200 p-6 hover:shadow-lg hover:shadow-blue-200 transition-shadow cursor-pointer">
                ...
                <button onClick={() => handleJobClick(job.id)} className="flex items-center justify-between w-full px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-md text-gray-700 text-sm font-medium transition-colors">
                  Ver Más
      ...
      {/* Paginación con puntos estilo Google */}
      <div className="flex justify-center mt-8 space-x-2">
        {Array.from({ length: totalPages }, (_, i) => i + 1)
          .filter((page) => {
            // Mostrar siempre primera, última, página actual y las cercanas
            return (
              page === 1 ||
              page === totalPages ||
          ...
          .map((page, idx, arr) => {
            // Agregar puntos suspensivos entre saltos
