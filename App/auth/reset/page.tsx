...
// Componente para la página de "Recuperar Contraseña"
const ForgotPassword = ({ onNavigate }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setIsLinkSent(true);
    setCountdown(60); // Iniciar el contador en 60 segundos
    setMessage(`Instrucciones para restablecer la contraseña enviadas a ${email}. Revisa tu bandeja de entrada.`);
  };
  ...
  return (
    <div className="flex-grow flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-md text-center border border-gray-200">
        ...
        <a href="#" onClick={() => onNavigate('login')} className="mt-6 inline-block text-sm text-blue-600 hover:underline">
...
// Componente para la página de "Login" (simulada)
  ...
  return (
    <div className="flex-grow flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md text-center">
        ...
        <a href="#" onClick={() => onNavigate('forgot-password')} className="mt-4 inline-block text-sm text-blue-600 hover:underline">
...
// Componente para la página de "Registro" (simulada)
  ...
  return (
    <div className="flex-grow flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md text-center">
        ...
        <a href="#" onClick={() => onNavigate('login')} className="mt-4 inline-block text-sm text-blue-600 hover:underline">
...
// Componente principal que maneja la vista actual
